...
Do not open `docs/VERSIONING.md` just to check the version. STATE.json is authoritative. Read VERSIONING.md when you need the version rules, completed-version history, or the pre-versioning baseline.
