...
Write-Output "- ChatGPT Reviewer Mode was added (the second-opinion/docs-workflow auditor role)."
...
Write-Output "5. Codex works locally, reads files directly before editing, runs the automated validation, and reports evidence."
Write-Output "6. User/controller approves manual validation, then commits, promotes, and pushes."

Write-Section "APPROVAL CHECKPOINT"
Write-Output "- Approve this packet layout"
Write-Output "- Request changes to packet layout"
Write-Output "- Proceed to the next scoped phase only after approval"
